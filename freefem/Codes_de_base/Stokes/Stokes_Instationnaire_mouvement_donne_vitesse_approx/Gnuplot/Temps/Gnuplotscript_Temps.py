...
proc_CN_L2H1.stdin.write("replot 2*x-1 w line lc rgb 'blue' t 'ordre 2'\n")
...
proc_CN_LinfL2.stdin.write("replot 2*x+5 w line lc rgb 'blue' t 'ordre 2'\n")
...
proc_BDF2_L2H1.stdin.write("replot 2*x+0.3 w line lc rgb 'blue' t 'ordre 2'\n")
...
proc_BDF2_LinfL2.stdin.write("replot 2*x+0.3 w line lc rgb 'blue' t 'ordre 2'\n")
